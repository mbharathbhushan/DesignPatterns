...
using AbstractDP10.Factory.AbstractFactory;

namespace AbstractDP10.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly AbstractFactory10Context _context;

        public EmployeesController(AbstractFactory10Context context)
        {
            _context = context;
        }
        ...
        {
            var abstractFactory10Context = _context.Employee.Include(e => e.EmployeeType);
            return View(await abstractFactory10Context.ToListAsync());
        }
        ...
        {
            ViewData["EmployeeTypeId"] = new SelectList(_context.EmployeeType, "Id", "EmployeeType1");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,JobDescription,Number,Department,HourlyPay,Bonus,EmployeeTypeId,HouseAllowances,MedicalAllowances,ComputerDetails")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
