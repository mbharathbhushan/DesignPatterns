...
using FactoryDesignPattern_08.Models;
using FactoryDesignPattern_08.Factory;
using FactoryDesignPattern_08.Managers;

namespace FactoryDesignPattern_08.Controllers
{
    public class EmployeesController : Controller
    {
        private readonly FactoryDP_08Context _context;

        public EmployeesController(FactoryDP_08Context context)
        {
            _context = context;
        }
        ...
        {
            var factoryDP_08Context = _context.Employee.Include(e => e.EmployeeType);
            return View(await factoryDP_08Context.ToListAsync());
        }
